...
public class CubeTest {
    ...
    public void setUp() throws Exception {
        ...
        outgoingState = new BrownianTraversedState(outgoingEdge, d1, d2, 1000);
        PrismState state2 = new BrownianTraversedState(basicEdge2, d2, d3, 1000);
        PrismState state3 = new BrownianTraversedState(basicEdge3, d3, d4, 1000);
        incomingState = new BrownianTraversedState(incomingBasicEdge, d3, d4, 1000);
